...
import org.learn.iceberg.catalog.ScriptRunner;

import static org.apache.iceberg.types.Types.NestedField.required;

public class IcebergCatalogTest extends BaseTest{
  ...
  private static void setupMetastoreDB(String dbURL) throws SQLException, IOException {
    ...
    InputStream inputStream = IcebergCatalogTest.class.getClassLoader().getResourceAsStream("hive-schema-3.1.0" +
        ".derby.sql");
  ...
  public static void main(String[] args) throws IOException, URISyntaxException, SQLException {
    ...
    HiveConf hiveConf = new HiveConf(conf, IcebergCatalogTest.class);
